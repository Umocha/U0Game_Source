#include "U0GameFeaturePolicy.h"
#include "U0Game/AbilitySystem/U0GameplayCueManager.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(U0GameFeaturePolicy)

///////////////////////////////////////////
// UU0GameFeaturePolicy
///////////////////////////////////////////
UU0GameFeaturePolicy::UU0GameFeaturePolicy(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UU0GameFeaturePolicy::InitGameFeatureManager()
{
	// GameFeature_AddGameplayCuePaths를 등록
	Observers.Add(NewObject<U0GameFeature_AddGameplayCuePaths>());

	// Observers를 순회하며,  GameFeaturesSubsyst m에 Observers를 순회하며 등록
...
void UU0GameFeaturePolicy::ShutdownGameFeatureManager()
{
...
///////////////////////////////////////////
// U0GameFeature_AddGameplayCuePaths
///////////////////////////////////////////
void U0GameFeature_AddGameplayCuePaths::OnGameFeatureRegistering(const UGameFeatureData* GameFeatureData, const FString& PluginName, const FString& PluginURL)
{
	...
	for (const UGameFeatureAction* Action : GameFeatureData->GetActions())
	{
		...
		if (const UGameFeatureAction_AddGameplayCuePath* AddGameplayCueGFA = Cast<UGameFeatureAction_AddGameplayCuePath>(Action))
		{
			...
			if (UU0GameplayCueManager* GCM = UU0GameplayCueManager::Get())
			{
				// RuntimeCueSet을 가져옴
...
void U0GameFeature_AddGameplayCuePaths::OnGameFeatureUnregistering(const UGameFeatureData* GameFeatureData, const FString& PluginName, const FString& PluginURL)
{
	const FString PluginRootPath = TEXT("/") + PluginName;
	for (const UGameFeatureAction* Action : GameFeatureData->GetActions())
	{
