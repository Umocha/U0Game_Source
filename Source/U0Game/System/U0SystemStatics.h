...
#include "U0SystemStatics.generated.h"
...
class UObject;
struct FFrame;
struct FU0GameplayEffectContext;

UCLASS()
class UU0SystemStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable)
	static float GetFloatValueByU0EffectContext(struct FGameplayEffectContextHandle Handle);
};
