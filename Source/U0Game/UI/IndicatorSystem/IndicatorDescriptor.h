...
class U0GAME_API UIndicatorDescriptor : public UObject
{
	GENERATED_BODY()
...
public:
	UU0IndicatorManagerComponent* GetIndicatorManagerComponent() { return ManagerPtr.Get(); }
	void SetIndicatorManagerComponent(UU0IndicatorManagerComponent* InManager);
...
private:
	...
	UPROPERTY()
	TWeakObjectPtr<UU0IndicatorManagerComponent> ManagerPtr;
