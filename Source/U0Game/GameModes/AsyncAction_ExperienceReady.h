 ...
 */
UCLASS()
class U0GAME_API UAsyncAction_ExperienceReady : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
public:
	...
	/*
	* UBlueprintAsyncActionBase's interface
	*/
	...
	*/
	...
	void Step3_HandleExperienceLoaded(const UU0ExperienceDefinition* CurrentExperience);
