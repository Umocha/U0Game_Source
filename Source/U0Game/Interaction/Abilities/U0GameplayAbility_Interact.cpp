...
#include "U0GameplayAbility_Interact.h"

#include "AbilitySystemComponent.h"
#include "U0Game/Interaction/IInteractableTarget.h"
#include "U0Game/Interaction/InteractionStatics.h"
#include "U0Game/Interaction/Tasks/AbilityTask_GrantNearbyInteraction.h"
#include "NativeGameplayTags.h"
#include "U0Game/Player/U0PlayerController.h"
#include "U0Game/UI/IndicatorSystem/IndicatorDescriptor.h"
#include "U0Game/UI/IndicatorSystem/U0IndicatorManagerComponent.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(U0GameplayAbility_Interact)
...
UU0GameplayAbility_Interact::UU0GameplayAbility_Interact(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	ActivationPolicy = EU0AbilityActivationPolicy::OnSpawn;
	InstancingPolicy = EGameplayAbilityInstancingPolicy::InstancedPerActor;
	NetExecutionPolicy = EGameplayAbilityNetExecutionPolicy::LocalPredicted;
}

void UU0GameplayAbility_Interact::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
...
void UU0GameplayAbility_Interact::UpdateInteractions(const TArray<FInteractionOption>& InteractiveOptions)
{
	if (AU0PlayerController* PC = GetU0PlayerControllerFromActorInfo())
	{
		if (UU0IndicatorManagerComponent* IndicatorManager = UU0IndicatorManagerComponent::GetComponent(PC))
		{
...
void UU0GameplayAbility_Interact::TriggerInteraction()
{
