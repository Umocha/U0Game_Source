...
#include "U0Game/Interaction/InteractionQuery.h"
...
void UAbilityTask_GrantNearbyInteraction::QueryInteractables()
{
	...
	if (World && ActorOwner)
	{
		...
		World->OverlapMultiByChannel(OUT OverlapResults, ActorOwner->GetActorLocation(), FQuat::Identity, U0_TraceChannel_Interaction, FCollisionShape::MakeSphere(InteractionScanRange), Params);
