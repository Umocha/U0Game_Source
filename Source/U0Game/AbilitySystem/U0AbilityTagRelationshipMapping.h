...
#include "U0AbilityTagRelationshipMapping.generated.h"

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FU0AbilityTagRelationship
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class U0GAME_API UU0AbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FU0AbilityTagRelationship> AbilityTagRelationships;
};
